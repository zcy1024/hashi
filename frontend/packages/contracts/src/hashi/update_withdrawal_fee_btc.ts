...
const $moduleName = "@local-pkg/hashi::update_withdrawal_fee_btc";
export const UpdateWithdrawalFeeBtc = new MoveStruct({
  name: `${$moduleName}::UpdateWithdrawalFeeBtc`,
  fields: {
    fee: bcs.u64(),
  },
});
...
export function propose(options: ProposeOptions) {
  ...
  return (tx: Transaction) =>
    tx.moveCall({
      ...
      module: "update_withdrawal_fee_btc",
      function: "propose",
