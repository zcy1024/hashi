...
const $moduleName = "@local-pkg/hashi::update_withdrawal_fee_sui";
export const UpdateWithdrawalFeeSui = new MoveStruct({
  name: `${$moduleName}::UpdateWithdrawalFeeSui`,
  fields: {
    fee: bcs.u64(),
  },
});
...
export function propose(options: ProposeOptions) {
  ...
  return (tx: Transaction) =>
    tx.moveCall({
      ...
      module: "update_withdrawal_fee_sui",
      function: "propose",
